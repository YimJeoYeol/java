...
public class PhoneBookManager {
	...
	public void inputData() {
		...
		int choice =0;
			...
			try {
				...
				System.out.println("1~3번 중 메뉴를 선택해 주세요");
				e.getMessage();
	...
	public void MainNumberCheck(int choice) throws Choice {
		if (choice < 1 || choice > 6) {
			throw new Choice("1~6사이의 메뉴를 선택하세요.");
		}
		


}
	public void SubNumberCheck(int choice) throws Choice {
		if (choice < 1 || choice > 3) {
			throw new Choice("1~3사이의 메뉴를 선택하세요.");
		}
	}}
